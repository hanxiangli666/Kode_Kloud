...
dataset = torchvision.datasets.ImageFolder(
        root=os.path.join(script_dir, "images"), # images directory
...
class CustomImageDataset(Dataset):
    def __init__(self, annotations_file, class_list, base_dir):
...
# Create the dataset
dataset = CustomImageDataset(annotations_file=os.path.join(script_dir, 'labels.csv'), 
